...
Answer: There is no clear indication that Normalization of the predictors in step B 
has decreased or increased the Mean of the Mean Squared Error. However, it has reduced the variance for the error 
